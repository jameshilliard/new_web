  ...
  function init()
  {
   ...
   function editOption(index)
   {
      if (document.appsTermProMenuForm.actionTable.options[index].value == '-1') {
         ...
         array = option.split("!");
         newRef = 'appsTermProMenuEntry.asp' + "?menuoption=" + index + "&" + target +"&SSID=<%get("_sid_");%>"+ "&title=" + array[0] + "&command=" + array[1];
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>      
    <td align="center" height="40" valign="middle">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="javascript:getSelectedAdd('appsTermProMenuEntry.asp','menuoption','350','250',target+"&SSID=<%get("_sid_");%>",'yes')">
