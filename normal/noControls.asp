                        ...
                        <td class="bgColor5" align="right">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr valign="bottom" align="right">
                                    <td align="right"><a href="javascript:newWindow('/onlineHelp.asp?SSID=<%get("_sid_");%>', 'Help', 800, 600, 'yes');"><img src="/Images/help.gif" alt="" width="78" height="40" border="0"></a></td>
									<td width="78">&nbsp;</td>
                                </tr>
                            </table>     
                        </td>
