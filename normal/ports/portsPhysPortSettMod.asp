...
<head>
		...
		if (numPorts == "1") {
			...
			if (top.family_model != "AVCS") {
				if (document.settings.elements[0].value == "105") {
					...
					document.configForm.elements[16].value = document.settings.elements[3].value;
					document.configForm.elements[15].value = document.settings.elements[4].value;
				}
			}
			for (var i=0; i < 6 ; i++) {
				document.configForm.elements[i+8].value = 
					document.settings.elements[i+5].value;
			}
		} else {
			if (top.family_model != "AVCS") {
				if (document.settings.elements[0].value == "105") {
					document.configForm.elements[14].value = document.settings.elements[1].value;
					document.configForm.elements[16].value = document.settings.elements[2].value;
	...
	{ 
		...
		if (document.settings.elements[0].value == "105") {
			if (numPorts == "1") {
				checkElement(document.settings.elements[3], true, true, false, true, 5, 200);
			} else {
				checkElement(document.settings.elements[2], true, true, false, true, 5, 200);
			}
		}
...
<div id="Layer2" name="Layer2" style="position:absolute; top:90px; width:100%; z-index:1; visibility: visible;" align="center">	
...
<tr align="left" valign="top"> 
    <td height="55" align="left" width="150">
      <font class="label">Polling Rate (seconds)</font>
    </td>
    <td height="55">
      <input class="formText" name="pollrate" type="text" size="4" maxlength="3" value="<%get("system.ports.physP.general.pmpollrate");%>">
    </td>
    <td height="55" align="right" width="150">
...
<div id="Layer1" name="Layer1" style="position:absolute; top:165px; width:100%; z-index:1; visibility: visible;" align="center">	
<table width="550" border="0" align="center" cellpadding="2" cellspacing="0">
...
if (top.family_model != "AVCS") document.write('\
        ...
        <input type="hidden" name="system.ports.physP.general.pmpollrate" value="">');
</script>
        <!--*************************************************************************-->
</form>
<script type="text/javascript">
